...
const AppointmentCard = () => {
    return (
        <div className="w-1/3 max-w-md bg-white rounded-xl border-2 border-gray-200 p-4 flex-shrink-0" dir="rtl">
            ...
            <button className="mt-4 w-full py-2.5 bg-blue-50 text-blue-600 rounded-lg flex items-center justify-center gap-2 hover:bg-blue-100 transition-colors">
                <MessageCircle className="w-5 h-5" />
                <span>أرسل استفسار لطبيبك</span>
            </button>
        </div>
    );
};
